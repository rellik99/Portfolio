    ...
    <div className='w-full  min-h-[100vh] mt-14'>
            ...
            <div className='w-11/12 flex flex-col gap-11 justify-center items-center max-w-[1160px] mx-auto pt-16'>
                ...
                <div className='flex space-x-2 justify-center items-center pb-14'>
                    <Link to='https://github.com/rellik99'><FaGithub className='text-4xl bg-white text-[#343d68] hover:text-[#e84949] transition duration-200 rounded-full p-2 cursor-pointer' /></Link>
                    <Link to='https://www.linkedin.com/in/prem-kumar-817743217/'><FaLinkedinIn className='text-4xl bg-white text-[#343d68] hover:text-[#e84949] transition duration-200 rounded-full p-2 cursor-pointer'  /></Link>
                    <Link to='https://www.instagram.com/prem_rellik99/'><FaInstagram className='text-4xl bg-white text-[#343d68] hover:text-[#e84949] transition duration-200 rounded-full p-2 cursor-pointer' /></Link>
                </div>      
